...
z = peaks(size(grid,2));
FV.verts=[x(1:end)',y(1:end)',z(1:end)']';
...
FV2.faces = delaunay(x,y);
FV2.vertices=FV.verts';
...
mesh_h=patch(FV2,'FaceVertexCdata',GausianCurvature','facecolor','interp','edgecolor','interp','EdgeAlpha',0.2);
